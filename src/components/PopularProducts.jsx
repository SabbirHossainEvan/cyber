...
const products = [
  {
    ...
    image: "/src/assets/popularProductsImage/Group 1.png",
    bg: "bg-gray-50",
  ...
  },
  {
    ...
    title: "iPad Pro",
    desc: "iPad combines a magnificent 10.2-inch Retina display, incredible performance, multitasking and ease of use.",
    image: "/src/assets/popularProductsImage/image 64.png",
    bg: "bg-white",
    textColor: "text-black",
  },
  {
    ...
    desc: "iPad combines a magnificent 10.2-inch Retina display, incredible performance, multitasking and ease of use.",
    image: "/src/assets/popularProductsImage/image 41.png",
    bg: "bg-gray-50",
    textColor: "text-black",
  },
  {
    ...
    title: "MacBook Pro",
    desc: "iPad combines a magnificent 10.2-inch Retina display, incredible performance, multitasking and ease of use.",
    image: "/src/assets/popularProductsImage/Macbook 1.png",
    bg: "bg-neutral-900",
